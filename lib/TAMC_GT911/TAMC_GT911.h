...
// Invalid pin marker — pass 0xFF (or -1 cast to uint8_t) to disable INT pin
// ESP32-3248S035C has R25 not populated so INT is physically disconnected
#define GT911_PIN_NONE 0xFF
